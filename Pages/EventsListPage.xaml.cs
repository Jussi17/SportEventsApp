...
public partial class EventsListPage : ContentPage
{
    ...
    {
        // Lisää staattiseen Events-kokoelmaan
        Events.Add(newEvent);

        // Päivitä FilteredEvents suodatuksen ja järjestyksen mukaisesti
    ...
    // Päivitetään suodatetut tapahtumat valitun lajin ja ajankohdan perusteella
